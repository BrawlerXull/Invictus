...
async function signUpUser() {
  ...
  const phone = document.getElementById("phone-signin").querySelector("input").value;
  const company = document.getElementById("company-signin").querySelector("input").value;
